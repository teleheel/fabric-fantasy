...
### General Bugfix & Tweak Mods - Client Only
...
- [Multi World Borders](https://www.curseforge.com/minecraft/mc-mods/world-border-fix)
...
- [Item Model Fix](https://www.curseforge.com/minecraft/mc-mods/item-model-fixs)
...
- [Advancement Plaques](https://www.curseforge.com/minecraft/mc-mods/advancement-plaques-fabric)
...
- [Villager Hats Mod](https://www.curseforge.com/minecraft/mc-mods/villager-hats-mod)
...
- [VillagerConfig](https://www.curseforge.com/minecraft/mc-mods/villagerconfig)
...
### Game Mechanics Tweaks - Client Only
...
- [Embellished Stone (Advancement Plaques)](https://www.curseforge.com/minecraft/texture-packs/embellished-stone-advancement-plaques)
...
## Configuration
### SIHYWTCAMC and SIHYWTCAMD
This pack contains two mods that drastically changes many of vanilla's mob
mechanics as well as the vanilla combat. These mods are - [So I heard you were talking crap about Minecraft's difficulty?](https://www.curseforge.com/minecraft/mc-mods/sihywtcamd) and [So I heard you were talking crap about Minecraft's combat?](https://www.curseforge.com/minecraft/mc-mods/sihywtcamc), respectively.
All of the changes can be disabled, and comprehensive lists of the changes are on
the mod pages.
